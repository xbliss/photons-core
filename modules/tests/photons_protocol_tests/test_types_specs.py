...
describe "optional":
    it "says NotSpecified is Optional", meta:
        spec = types.optional(mock.Mock(name="spec"))
        assert spec.normalise(meta, sb.NotSpecified) is types.Optional

    it "normalises Optional as is", meta:
        spec = types.optional(mock.Mock(name="spec"))
        assert spec.normalise(meta, types.Optional) is types.Optional

    it "normalises anything else using self.spec", meta:
